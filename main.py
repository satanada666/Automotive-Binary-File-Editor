...
from PyQt5.QtWidgets import QFileDialog, QMessageBox, QGroupBox, QVBoxLayout, QLabel, QInputDialog, QDialog, QGridLayout, QPushButton, QSpinBox, QLineEdit
import requests
import webbrowser
...
def edit_mileage(win, settings, current_encoder):
    ...
    try:
        ...
        if dialog.exec_() == QDialog.Accepted:
            ...
            # Обновляем пробег
            if ignore_vin_pin:
                # Используем старый подход для проблемных модулей
