...
class Ducato_edc16c39_NI(Encoder):
    def __init__(self):
        super().__init__()
        ...
        self.search_pattern = bytes([0x9A, 0x09, 0x9A, 0x01, 0x01])
        
        # Ожидаемые значения для проверки (4-й и 5-й байт)
        self.expected_value_4 = 0x01
        self.expected_value_5 = 0x01
        
        # Новые значения для отключения иммобилайзера (4-й и 5-й байт)
        self.new_value_4 = 0x00
        self.new_value_5 = 0x00
